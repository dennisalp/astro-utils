...
Get XMM/EPIC, CXO/ACIS, and Swift/XRT X-ray light curves
for a SIMBAD object or provided coordinates. 

Examples:
Either strict SIMBAD name:
util_xlc.py "SN 1987A"
util_xlc.py "Calvera"
util_xlc.py "3C 273"

Or any coordinate format understood by astropy:
util_xlc.py 308.7531289, 60.1918233
util_xlc.py 05:36:10.123 -69:35:09.107
util_xlc.py "23 23 53.316" "+58 40 12.06"
...
if __name__ == "__main__":
    ...
    print('Printing to {0:s}'.format(out))
