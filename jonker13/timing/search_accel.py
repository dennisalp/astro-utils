...
# Accelerated
x['mode'] = 'accel'
x['mc'] = 100  # Msun, companion mass
x['fr'] = .05  # maximum fraction of orbit of the segment
x['tm'] = 1e4  # s, shortest segment
x['nm'] = 300  # fewest counts in a segment
x['as'] = 1.0  # acceleration step size, units of frequency bins

# Binary scan
x['mode'] = 'scan'
x['nMp'] = 3  # number of pulsar masses
x['nMc'] = 3  # number of companion masses
x['nPb'] = 3  # number of binary periods
x['nTT'] = 3  # number of epoch of periastron passage
x['nEc'] = 3  # number of eccentricity steps (1 for circular)
x['nWW'] = 3  # number of longitude of periastron
