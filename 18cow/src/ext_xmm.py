...
################################################################
files = sorted(glob('/Users/silver/dat/xmm/cow/0822580401_repro/epn_cl_src_bc.evt'))
out = '/Users/silver/box/phd/pro/cow/nus/dat/'
dt = 0.0734
...
for ii, ff in enumerate(files):
    ...
    tt = tt - np.random.uniform(0, 0.0734, tt.size)
    do_stuff(tt)
